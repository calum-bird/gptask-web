            ...
            <div className="mx-auto max-w-2xl">
              <div className="max-w-lg">
                ...
                <div className="mt-24 sm:mt-32 lg:mt-16">
                  <a
                    href="https://github.com/calum-bird/gptask-web"
                ...
                <span className="text-indigo-600 text-3xl mt-3">
                  (You&apos;ll only have yourself to blame)
                </span>

                <p className="mt-6 text-lg leading-8 text-gray-600">
                  Login to GitHub, choose a repo, and use LLMs to review your
                  code on every PR. You&apos;ll love getting judged by an LLM.
                </p>
